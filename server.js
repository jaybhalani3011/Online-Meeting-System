const dotenv = require("dotenv").config(); //({ path : './.env_sample'});
...
mongoose
  .connect(process.env.DB_URI, { //"mongodb://localhost:27017/omsdb"
...
app.use(cookie({ maxAge: 30 * 24 * 60 * 60 * 1000, keys: ["onlinemeetingsystem"] }));
